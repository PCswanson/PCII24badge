...
def draw_badge():
    ...
    jpeg.decode(WIDTH - IMAGE_WIDTH, 68)
    ...
    display.set_pen(15)
    display.rectangle(1, HEIGHT - DETAILS_HEIGHT * 2, TEXT_WIDTH - IMAGE_WIDTH, DETAILS_HEIGHT - 1)
    display.rectangle(1, HEIGHT - DETAILS_HEIGHT, TEXT_WIDTH - IMAGE_WIDTH, DETAILS_HEIGHT - 1)
